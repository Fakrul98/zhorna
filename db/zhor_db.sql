...
INSERT INTO `instalment` (`ins_id`, `date`, `member_id`, `member_name`, `per_inst`, `due_inst`, `area`, `created_at`, `update_at`) VALUES
...
(7, '2018-08-03', 10, 'hasan', 1000, 49000, 'mir-bazar', '2018-08-03 06:47:39', '0000-00-00 00:00:00'),
(8, '2018-08-03', 10, 'hasan', 1000, 49000, 'mir-bazar', '2018-08-03 06:48:26', '0000-00-00 00:00:00'),
(9, '2018-08-03', 2, 'Murad', 5000, 95000, 'mir-bazar', '2018-08-03 13:49:51', '0000-00-00 00:00:00'),
(10, '2018-08-10', 10, 'hasan', 2000, 48000, 'mir-bazar', '2018-08-03 13:54:57', '0000-00-00 00:00:00'),
(11, '2018-08-03', 10, 'hasan', 5000, 45000, 'mir-bazar', '2018-08-03 13:56:33', '0000-00-00 00:00:00'),
(12, '2018-08-04', 10, 'hasan', 5000, 45000, 'mir-bazar', '2018-08-03 13:58:19', '0000-00-00 00:00:00'),
(13, '2018-08-05', 2, 'Murad', 5000, 95000, 'mir-bazar', '2018-08-03 14:04:50', '0000-00-00 00:00:00'),
(14, '2018-08-10', 6, 'hasan-2', 500, 49501, '', '2018-08-09 16:36:03', '0000-00-00 00:00:00');
...
INSERT INTO `loan` (`loan_id`, `member_id`, `member_name`, `amount`, `date`, `ref_member_id`, `national_id`, `sex`, `area`, `status`, `created_at`, `update_at`) VALUES
...
INSERT INTO `login` (`login_id`, `user_name`, `user_id`, `user_type`, `email`, `password`, `created_at`, `update_at`) VALUES
(1, 'Fakrul hasan', 1, 'Super Admin', 'fakrulhasan98@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '2018-08-07 07:00:05', '0000-00-00 00:00:00'),
(2, 'dolon', 2, 'Admin', 'dolon@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '2018-08-07 09:58:34', '0000-00-00 00:00:00');
...
INSERT INTO `user_deposit` (`deposit_id`, `date`, `member_id`, `member_name`, `dep_amount`, `dep_total`, `area`, `dep_status`, `created_at`, `update_at`) VALUES
...
(18, '2018-08-07', 2, 'Murad', 500, 9300, ' ', 1, '2018-08-07 16:30:59', '2018-08-07 16:30:59'),
(19, '2018-08-07', 2, 'Murad', 0, 9300, ' ', 1, '2018-08-07 16:39:16', '2018-08-07 16:39:16'),
(20, '2018-08-09', 9, 'Anwar', 1000, 1000, 'mir-bazar ', 1, '2018-08-09 16:31:01', '2018-08-09 16:31:01');
...
(14, '1533833167_86141_STR.-ROYAL-FRONT.forweb_1024x1024.jpg', 51, 'Mainudden', 'Md.Serije', 'Komola', 'Chittagong,Bangladesh', 'minuddin@gmail.com', '01816044944', '0000-00-00', 2147483647, 'male', 'mir-bazar', '2018-08-09 16:46:07', '2018-08-09 16:46:07'),
(15, '1533833442_83905_STREAK-FUCHSIA.forweb_1024x1024.jpg', 52, 'sumun', 'Md.Serije', 'Komola', 'Chittagong,Bangladesh.', 'dolon@gmail.com', '01816044945', '2018-08-13', 2147483647, 'male', 'mir-bazar', '2018-08-09 16:50:42', '2018-08-09 16:50:42');
...
INSERT INTO `user_withdraw` (`withdraw_id`, `date`, `member_id`, `member_name`, `withdraw_amount`, `withdraw_total`, `area`, `status`, `created_at`, `updated_at`) VALUES
(1, '0000-00-00', 2, 'Murad', 200, 200, 'mir-bazar ', 1, '2018-07-30 23:50:21', NULL),
(2, '2018-08-01', 2, 'Murad', 400, 600, 'mir-bazar ', 1, '2018-07-30 23:50:44', NULL),
(3, '2018-08-03', 10, 'hasan', 1000, 1000, 'mir-bazar ', 1, '2018-07-30 23:52:37', NULL),
(4, '2018-08-03', 6, 'hasan-2', 20000, 20000, 'mazu-khan ', 1, '2018-07-31 09:56:00', NULL),
(5, '0000-00-00', 23, 'jahanara', 1000, 1000, 'mir-bazar ', 1, '2018-08-07 22:10:52', NULL),
(6, '2018-08-07', 23, 'jahanara', 1000, 2000, 'mir-bazar ', 1, '2018-08-07 22:12:26', NULL),
(7, '2018-08-07', 23, 'jahanara', 500, 2500, 'mir-bazar ', 1, '2018-08-07 22:12:56', NULL),
(8, '2018-08-10', 20, 'Kamal', 200, 200, 'mir-bazar ', 1, '2018-08-09 22:41:29', NULL);
...
--
ALTER TABLE `instalment`
  MODIFY `ins_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `login`
  MODIFY `login_id` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `user_deposit`
--
ALTER TABLE `user_deposit`
  MODIFY `deposit_id` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
-- AUTO_INCREMENT for table `user_reg`
--
ALTER TABLE `user_reg`
  MODIFY `u_id` int(99) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
